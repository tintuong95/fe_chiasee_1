...
export default function Home() {
  return (
			<div>
				<div className='ud-header absolute top-0 left-0 z-40  w-full bg-neutral-800'>
					<div className='container m-auto'>
						<div className='relative -mx-4 flex items-center justify-between'>
							<div className='w-60 max-w-full px-4'>
								<a href='index.html' className='navbar-logo block w-full py-5'>
									<img src={LogoWhite} alt='logo' className='header-logo w-full h-10' />
								</a>
							</div>
							<div className='flex w-full items-center justify-between px-4'>
								<div>
									...
									<nav
										...
										<ul className='blcok lg:flex text-sm mb-0'>
											<li className='group relative'>
												<a
													href='#home'
													className='ud-menu-scroll mx-6 flex py-2  text-dark group-hover:text-primary lg:mr-0 lg:inline-flex lg:py-6 lg:px-0 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70'>
													Trang chủ
												</a>
											</li>
											<li className='group relative'>
												<a
													href='#about'
													className='ud-menu-scroll mx-6 flex py-2  text-dark group-hover:text-primary lg:mr-0 lg:ml-7 lg:inline-flex lg:py-6 lg:px-0 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70 xl:ml-12'>
													Thông tin
												</a>
											</li>
											<li className='group relative'>
											...
											<li className='submenu-item group relative'>
												<a
													href='#SDAF'
													className='relative mx-6 flex py-2  text-dark after:absolute after:right-1 after:top-1/2 after:mt-[-2px] after:h-2 after:w-2 after:-translate-y-1/2 after:rotate-45 after:border-b-2 after:border-r-2 after:border-current group-hover:text-primary lg:mr-0 lg:ml-8 lg:inline-flex lg:py-6 lg:pl-0 lg:pr-4 lg:text-white lg:after:right-0 lg:group-hover:text-white lg:group-hover:opacity-70 xl:ml-12'>
													Pages
												</a>
								...
								<div className='hidden justify-end pr-16 sm:flex lg:pr-0 text-sm'>
									<Link
										to='/login'
										className='loginBtn py-3 px-7  text-white hover:opacity-70'>
										Login
									</Link>
									<Link
										to={'/signup'}
										className='signUpBtn rounded-lg bg-white bg-opacity-20 py-3 px-6  text-white duration-300 ease-in-out hover:bg-opacity-100 hover:text-dark'>
										Sign Up
									</Link>
								</div>
							</div>
				...
				<div
					id='home'
					className='relative overflow-hidden bg-zinc-800 pt-[120px] md:pt-[130px] lg:pt-[160px]'>
					<div className='container m-auto'>
							...
							<div className='w-full px-4'>
								<div
									...
									<h1 className='mb-8 text-3xl font-bold leading-snug text-white sm:text-4xl sm:leading-snug md:text-[45px] md:leading-snug'>
										LƯU TRỮ , CHIA SẼ , KỈ NIỆM DƯỚI DẠNG ALBUM ẢNH
									</h1>
									{/* <p className='mx-auto mb-10 max-w-[600px]  text-[#e4e4e4] sm:text-lg sm:leading-relaxed md:text-xl md:leading-relaxed'>
									...
									<ul className='mb-10 flex flex-wrap items-center justify-center'>
										<li>
											<Link
												to='/view/1'
												className='inline-flex animate-bounce items-center justify-center rounded-lg bg-white py-4 px-6 text-center text-base font-medium text-dark transition duration-300 ease-in-out hover:text-primary hover:shadow-lg sm:px-10'>
												DEMO
											</Link>
										</li>
										<li>
							...
							<div className='w-full px-4'>
								<div className='mb-12 max-w-[620px] lg:mb-20'>
									...
									<p className='text-lg leading-relaxed text-body-color sm:text-xl sm:leading-relaxed'>
										Chúng tôi cung cấp những giải pháp lưu trữ , chỉnh sửa và chia sẻ
										những hình ảnh kỹ niệm của các bạn đến với mọi người.
									</p>
								</div>
							</div>
						</div>
						<div className='-mx-4 flex flex-wrap'>
							<div className='w-full px-4 md:w-1/2 lg:w-1/4'>
								<div className='wow fadeInUp group mb-12 bg-white' data-wow-delay='.1s'>
									...
									<h4 className='mb-3 text-xl font-bold text-dark'>LƯU TRỮ CLOUD</h4>
									<p className='mb-8 text-body-color lg:mb-11'>
										Hình ảnh của các bạn sẻ được lưu trữ trên Cloud tránh tình trạng mất
										dữ liệu.
									</p>
									<a
										href='#SDAF'
							...
							<div className='w-full px-4 md:w-1/2 lg:w-1/4'>
								<div
									...
									<h4 className='mb-3 text-xl font-bold text-dark'>CHỈNH SỬA ẢNH</h4>
									<p className='mb-8  text-body-color lg:mb-11'>
										Cho phép người dùng có thể chỉnh sửa ản của mình trên website.
									</p>
									<a
										href='#SDAF'
										className='text-base  font-medium text-body-color hover:text-primary'>
								...
								<div className='w-full px-4'>
									<div className='items-center justify-between overflow-hidden border lg:flex'>
										<div className='w-full py-12 px-7 sm:px-12 md:p-16 lg:max-w-[565px] lg:py-9 lg:px-16 xl:max-w-[640px] xl:p-[70px]'>
											...
											<p className='mb-9 text-base leading-relaxed text-body-color'>
												The main thrus is to focus on educating attendees on how to best
												protect highly vulnerable business applications with interactive
												panel.
											</p>
											<a
										...
										<div className='text-center'>
											<div className='relative z-10 inline-block'>
												<img src={AboutImage} alt='imdage' className='mx-auto lg:ml-auto' />
											</div>
										</div>
									</div>
								</div>
              ...
              '>
							...
							<div className='w-full md:w-1/2 lg:w-1/3'>
								<div
									className='wow fadeInUp relative z-10 mb-10 overflow-hidden rounded-xl bg-zinc-800 bg-gradient-to-b from-primary to-[#179BEE] py-10 px-8 text-center shadow-pricing sm:p-12 lg:py-10 lg:px-6 xl:p-12'
									data-wow-delay='.1s
              '>
									...
									<div className='ud-brands-logo flex flex-wrap items-center'>
										<div className='ud-single-logo mr-10 mb-5 max-w-[140px]'>
											<a
												...
												<img
													src={require('./assets/images/brands/tailgrids.svg').default}
													alt='tailgrids'
										...
										<div className='ud-single-logo mr-10 mb-5 max-w-[140px]'>
											<a
												...
												rel='nofollow noopner noreferrer'>
												<img
													src={require('./assets/images/brands/ayroui.svg').default}
													alt='ayroui'
													className='grayscale duration-300 hover:filter-none'
												/>
											</a>
										...
										<div className='ud-single-logo mr-10 mb-5 max-w-[140px]'>
											<a
												...
												rel='nofollow noopner noreferrer'>
												<img
													src={require('./assets/images/brands/uideck.svg').default}
													alt='uideck'
													className='grayscale duration-300 hover:filter-none'
												/>
											</a>
										...
										<div className='ud-single-logo mr-10 mb-5 max-w-[140px]'>
											<a
												...
												rel='nofollow noopner noreferrer'>
												<img
													src={require('./assets/images/brands/graygrids.svg').default}
													alt='graygrids'
													className='grayscale duration-300 hover:filter-none'
												/>
											</a>
										...
										<div className='ud-single-logo mr-10 mb-5 max-w-[140px]'>
											<a
												...
												rel='nofollow noopner noreferrer'>
												<img
													src={require('./assets/images/brands/lineicons.svg').default}
													alt='lineicons'
													className='grayscale duration-300 hover:filter-none'
												/>
											</a>
						...
						<div className='-mx-4 flex flex-wrap justify-center'>
							<div className='w-full px-4 sm:w-1/2 lg:w-1/4'>
								<div className='wow fadeInUp mb-10' data-wow-delay='.1s'>
									...
									<div className='text-center'>
										<h4 className='mb-2 text-lg font-medium text-dark'>Adveen Desuza</h4>
							...
							<div className='w-full px-4 sm:w-1/2 lg:w-1/4'>
								<div className='wow fadeInUp mb-10' data-wow-delay='.2s'>
									...
									<div className='text-center'>
										<h4 className='mb-2 text-lg font-medium text-dark'>Andrieo Gloree</h4>
										<p className='mb-5 text-sm font-medium text-body-color'>
											App Developer
										</p>
										<div className='flex items-center justify-center'>
							...
							<div className='w-full px-4 sm:w-1/2 lg:w-1/4'>
								<div className='wow fadeInUp mb-10' data-wow-delay='.25s'>
									...
									<div className='text-center'>
										<h4 className='mb-2 text-lg font-medium text-dark'>Jackie Sanders</h4>
										<p className='mb-5 text-sm font-medium text-body-color'>
											Content Writer
										</p>
										<div className='flex items-center justify-center'>
				...
				<footer
						...
						<div className='-mx-4 flex flex-wrap'>
							<div className='w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12'>
								<div className='mb-10 w-full'>
									<a href='#SDAF' className='mb-6 inline-block max-w-[160px]'>
										<img
											src={require('./assets/images/logo/logo-white.svg').default}
											alt='logo'
									...
									<div className='-mx-3 flex items-center'>
										<a href='#SDAF' className='px-3 text-[#dddddd] hover:text-white'>
											<svg
												width='10'
												height='18'
												viewBox='0 0 10 18'
									...
									<ul className='flex flex-wrap items-center'>
										<li>
											<a
												...
												<img
													src={
														require('./assets/images/footer/brands/tailgrids.svg').default
													}
													alt='tailgrids'
												/>
											</a>
										...
										<li>
											<a
												...
												className='mb-6 mr-5 block max-w-[120px] xl:max-w-[100px] 2xl:max-w-[120px]'>
												<img
													src={require('./assets/images/footer/brands/ayroui.svg').default}
													alt='ayroui'
												/>
											</a>
										</li>
										<li>
											<a
												...
												<img
													src={
														require('./assets/images/footer/brands/ecommerce-html.svg')
															.default
													}
													alt='ecommerce-html'
												/>
										...
										<li>
											<a
												...
												<img
													src={
														require('./assets/images/footer/brands/graygrids.svg').default
													}
													alt='graygrids'
												/>
											</a>
										...
										<li>
											<a
												...
												className='mb-6 mr-5 block max-w-[120px] xl:max-w-[100px] 2xl:max-w-[120px]'>
												<img
													src={require('./assets/images/footer/brands/uideck.svg').default}
													alt='uideck'
												/>
											</a>
										</li>
					...
					<div>
						<span className='absolute left-0 top-0 z-[-1]'>
							<img
								src={require('./assets/images/footer/shape-1.svg').default}
								alt='d'
							/>
						</span>
						...
						<span className='absolute bottom-0 right-0 z-[-1]'>
							<img
								src={require('./assets/images/footer/shape-3.svg').default}
								alt='d'
							/>
						</span>
